...
In answering this question, we found two sources of bottlenecks \team{UPDATE} in the Spark Streaming architecture: receiving data and running tasks. We implement enhancements for running tasks, and offer suggestion on how to tune the process of receiving data.
