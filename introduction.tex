...
Several data analytics systems~\cite{Storm,SparkStreaming,Trill,Naiad,Niagara,StreamInsight} provide easy-to-use and deploy frameworks for these types of applications. 
