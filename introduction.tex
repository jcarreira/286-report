...
In Section 5 we evaluate the architecture of Spark Streaming with respect to real and synthetic workloads, and discuss how different factors affect the performance of the system. We then discuss the next steps needed to bring low latency to the micro-batch approach in streaming.
