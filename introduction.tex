...
require the computation of results in a timely fashion in order to provide interactivity and fast response.
Several data analytics systems~\cite{Babu:2001:CQO:603867.603884,TelegraphCQ,Storm,SparkStreaming,Trill,Naiad,Niagara,StreamInsight,Carney:2002:MSN:1287369.1287389,Sullivan:1998:TSM:1268256.1268258} provide easy-to-use and deploy frameworks for these types of applications. 
...
In this paper we argue that it is possible to support low-latency and high throughput streaming applications with a general-purpose framework like Spark.
Even though the focus of our analysis is in Spark Streaming and Spark, we believe that our analysis and conclusions can inform the design and 
improvement of other systems that follow the micro-batch approach.
